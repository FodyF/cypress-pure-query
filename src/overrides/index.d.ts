...
declare namespace Cypress {
  interface Chainable {
    ...
    children<E extends Node = HTMLElement>(options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
    children<K extends keyof HTMLElementTagNameMap>(selector: K, 
      options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>>
    children<E extends Node = HTMLElement>(selector: string, 
      options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
    ...
    eq<E extends Node = HTMLElement>(index: number, options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
   
    filter<K extends keyof HTMLElementTagNameMap>(selector: K, 
      options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>> // automatically returns the correct HTMLElement type
    ...
    next<K extends keyof HTMLElementTagNameMap>(selector: K, 
      options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>>
    next<E extends Node = HTMLElement>(options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
    next<E extends Node = HTMLElement>(selector: string, 
      options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>

    nextAll<K extends keyof HTMLElementTagNameMap>(selector: K, 
      options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>>
    nextAll<E extends HTMLElement = HTMLElement>(options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
    ...
    not(selector: string, options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery>

    parent<K extends keyof HTMLElementTagNameMap>(selector: K, 
      options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>>
    parent<E extends Node = HTMLElement>(options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
    parent<E extends Node = HTMLElement>(selector: string, 
      options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
    
      parents<K extends keyof HTMLElementTagNameMap>(selector: K, 
        options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>>
      parents<E extends Node = HTMLElement>(options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
      ...
      prev<K extends keyof HTMLElementTagNameMap>(selector: K, 
        options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>>
      prev<E extends Node = HTMLElement>(options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
      prev<E extends Node = HTMLElement>(selector: string, 
        options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
  
      prevAll<K extends keyof HTMLElementTagNameMap>(selector: K, 
        options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>>
      prevAll<E extends Node = HTMLElement>(options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
      ...
      siblings<K extends keyof HTMLElementTagNameMap>(selector: K, 
        options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<HTMLElementTagNameMap[K]>>
      siblings<E extends Node = HTMLElement>(options?: Partial<Loggable & Timeoutable & SoftFail>): Chainable<JQuery<E>>
